...
public class MainActivity extends ListActivity {
    ...
    private String[] titles = {"Enforcing constraints", "Percent Dimensions", "Barrier", "Group", "围绕旋转", "点击布局重新排列", "模板功能", "动态替换", "Baseline 对齐", "边距处理"};
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        switch (position) {
            ...
            case 8:
                ...
                break;
            case 9:
                startActivity(new Intent(this, TestActivity.class).putExtra(TestActivity.TYPE, TestActivity.MARGIN));
                break;
